...
require([
    ...
    $('.sidenav').find('a').on('click', function(e) {
        ...
        if ($(this).attr('class') === "link-nav-list-header") {
            var group = id.slice(5);
            $( "li > a.nav-list-item" ).not('[data-group=' + group + ']').removeClass('active');
            $('li > a.nav-list-item[data-group=' + group + ']').toggleClass('active');
        }
    });
